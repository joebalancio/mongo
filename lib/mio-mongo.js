...
exports.find = function (query, next) {
  ...
  Resource.mongo.collection.find(mongoQuery, options)
    .toArray(function (err, docs) {
      ...
      collection.skip = options.skip || 0;
      collection.limit = options.limit || 25;
...
function buildQueryOptions (query) {
  ...
  var skip = Number(opts.skip || opts.offset || 0);
  var limit = Number(opts.limit || opts.size || opts.pageSize || 25);
